...
- Optional Windows executable (`.exe`) via GitHub Releases
...
```bash
git clone https://github.com/SadayanP/Text-Classifier-API-Desktop-Client.git
cd Text-Classifier-API-Desktop-Client
```
...
Download the latest Windows build from the [Releases page](https://github.com/SadayanP/Text-Classifier-API-Desktop-Client/releases).

> The backend must be running on `http://127.0.0.1:8000` for the client to work.
